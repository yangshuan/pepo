/* Generated By:JavaCC: Do not edit this line. SasParserTokenManager.java */
...
/** Token Manager. */
public class SasParserTokenManager implements SasParserConstants
{
...
private final int jjStopStringLiteralDfa_0(int pos, long active0)
{
   switch (pos)
   {
      ...
      case 1:
         ...
         if ((active0 & 0x1640000L) != 0L)
            return 30;
         return -1;
      case 2:
         if ((active0 & 0x19b8000L) != 0L)
         {
            jjmatchedKind = 41;
            jjmatchedPos = 2;
            return 30;
...
private int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 105:
         return jjMoveStringLiteralDfa1_0(0x1440000L);
      case 108:
   ...
   switch(curChar)
   {
      case 101:
         if ((active0 & 0x8000L) != 0L)
            ...
            return jjStartNfaWithStates_0(7, 16, 30);
         break;
      case 112:
...
static final int[] jjnextStates = {
   32, 33, 38, 39, 42, 43, 8, 51, 56, 19, 20, 22, 10, 11, 13, 47, 
   49, 2, 52, 53, 55, 4, 5, 8, 10, 11, 15, 13, 19, 20, 24, 22, 
   34, 35, 8, 42, 43, 8, 58, 59, 61, 6, 7, 12, 14, 16, 21, 23, 
   25, 28, 36, 37, 40, 41, 44, 45, 
};
...
"\162\145\147\151\163\164\145\162", "\151\146", "\145\154\163\145", "\164\150\145\156", "\157\162", "\151\156", 
"\154\141\142\145\154", "\151\156\164\145\162\143\145\160\164", "\173", "\175", "\133", "\135", "\50", 
"\51", "\53", "\55", "\52", "\57", "\75\75", "\41\75", "\74", "\76", "\74\75", 
"\76\75", null, null, null, "\75", "\56", "\73", "\54", };
...
/** Constructor. */
public SasParserTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public SasParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
